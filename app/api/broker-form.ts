...
export default async function handler(
  ...
  try {
    ...
    const submitUrl =
      intermediary_type === "Broker" ? brokerEndpoint : agentEndpoint;
    ...
    const existingData: (string | number)[][] = XLSX.utils.sheet_to_json(
      worksheet,
      { header: 1 },
    );
...
https://www.birdviewmicroinsurance.com/agent_data.xlsx`,
      attachments: [{ filename: "agent_data.xlsx", content: updatedBuffer }],
    };
