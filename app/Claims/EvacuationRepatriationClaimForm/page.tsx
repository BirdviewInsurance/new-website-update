...
export default function EvacuationRepatriationClaimForm() {
  ...
  const onSubmit = async (data: Record<string, any>) => {
    ...
    try {
      ...
      const resp = await fetch("/api/evacuation-claim", {
        method: "POST",
        body: fd,
      });
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(180deg,#0284C7 0%, #2563EB 50%, #1E3A8A 100%)",
                minHeight: 420,
                position: "relative",
                overflow: "hidden",
              }}
            ...
            >
              <div className="z-10 relative flex flex-col h-full">
                ...
                <div className="mt-6 text-xs opacity-90 space-y-1">
                  ...
                  <div>
                    Form ID: <span className="font-mono">EVAC-CLAIM-2025</span>
                  </div>
                </div>
                ...
                <CardHeader className="py-6">
                  <div className="text-left">
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                      Provide accurate information and attach required
                      documents. For repatriation of mortal remains include
                      death certificate and repatriation invoice.
                    </p>
                  </div>
                </CardHeader>
                  ...
                  >
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <Input
                          label={
                            <RequiredLabel text="Insured Person's Full Name" />
                          }
                        ...
                        <Input
                          className="md:col-span-2"
                          label={
                            <RequiredLabel text="Contact (phone & email)" />
                          }
                        ...
                        <Input
                          label={
                            <RequiredLabel text="Claimant / Primary Insured Email" />
                          }
                          type="email"
                        ...
                        <div className="col-span-full md:col-span-1">
                          <Select
                            label={
                              <RequiredLabel text="Claimant Relationship" />
                            }
                            {...register("claimantRelationship", {
                              required: "This field is required",
                            })}
                            errorMessage={
                              errors.claimantRelationship?.message as string
                            }
                            isInvalid={!!errors.claimantRelationship}
                          >
                            <SelectItem key="SELF">Self</SelectItem>
                            <SelectItem key="RECRUITING_AGENCY">
                              Recruiting Agency
                            </SelectItem>
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Input
                          label={
                            <RequiredLabel text="Trip Destination (Country)" />
                          }
                          {...register("destinationCountry", {
                            required: "This field is required",
                          })}
                          errorMessage={
                            errors.destinationCountry?.message as string
                          }
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Textarea
                          label={
                            <RequiredLabel text="Circumstances of Incident" />
                          }
                          rows={4}
                          {...register("incidentCircumstances", {
                            required: "This field is required",
                          })}
                          errorMessage={
                            errors.incidentCircumstances?.message as string
                          }
                      ...
                      <div className="space-y-3">
                        <Input
                          label={
                            <RequiredLabel text="Reason for Evacuation / Repatriation" />
                          }
                          {...register("evacuationReason", {
                            required: "This field is required",
                          })}
                          errorMessage={
                            errors.evacuationReason?.message as string
                          }
                          isInvalid={!!errors.evacuationReason}
                        />
                        <Input
                          label="Initial Medical Treatment (date & place)"
                          {...register("initialTreatment")}
                        />
                        <Input
                          label="Treating Physician's Name"
                          {...register("treatingPhysician")}
                        />

                        <div className="grid grid-cols-2 gap-3">
                          <Select
                            label="Reported to Assistance Provider?"
                          ...
                          <Input
                            label="Notification Date / Confirmation #"
                            type="date"
                            {...register("notificationInfo")}
                          />
                        </div>
                      </div>
                    </section>
                    ...
                    <section>
                      ...
                      >
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-1.5 h-10 rounded bg-gradient-to-b from-blue-500 to-indigo-600" />
                          <h3 className="font-semibold text-primary">
                            4 — Details of Expenses Claimed
                          </h3>
                        </div>
                      </motion.div>

                      <p className="text-sm text-slate-500 mb-3">
                        List out-of-pocket expenses and attach itemized bills &
                        receipts.
                      </p>

                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Input
                          label="Emergency Transport Date"
                          type="date"
                          {...register("transportDate")}
                        />
                        <Input
                          label="Transport Description (air ambulance / ground / escort)"
                          {...register("transportDesc")}
                        />
                        <Input
                          label="Transport Amount (USD)"
                        ...
                        />
                        <Input
                          label="Repatriation Description"
                          {...register("repatDesc")}
                        />
                        <Input
                          label="Repatriation Amount (USD)"
                          {...register("repatAmount")}
                        />
                        <Input
                          label="Medical Expense Date"
                          type="date"
                          {...register("medicalDate")}
                        />
                        <Input
                          label="Medical Description"
                          {...register("medicalDesc")}
                        />
                        <Input
                          label="Medical Amount (USD)"
                          {...register("medicalAmount")}
                        />
                        <Input
                          label="Other Expense Date"
                          type="date"
                          {...register("otherDate")}
                        />
                        <Input
                        ...
                        />
                        <Input
                          label="Other Expense Amount (USD)"
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Input
                          label={
                            <RequiredLabel text="Preferred Payment Method" />
                          }
                    ...
                    <section>
                      ...
                      >
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-1.5 h-10 rounded bg-gradient-to-b from-blue-500 to-indigo-600" />
                          <h3 className="font-semibold text-primary">
                            6 — Supporting Documents, Declaration & Signature
                          </h3>
                        </div>
                      </motion.div>

                      <p className="text-sm text-slate-500 mb-2">
                        Upload scanned copies: medical records, itemized bills,
                        death certificate (if applicable), police report,
                        passport copies, travel itinerary, evacuation invoice,
                        repatriation invoice, proof of payment, exit visa,
                        evacuation authorization letter, flight details.
                      </p>
                      ...
                      {files.length > 0 && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-4">
                          {files.map((f, i) => (
                            <div
                              key={i}
                              className="flex items-center justify-between p-2 rounded border border-slate-100 bg-white"
                            >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                        <div className="md:col-span-2">
                          <label className="block text-sm mb-2">
                            Digital Signature (draw inside the box)
                          </label>
                          ...
                          <div className="flex gap-2 mt-2">
                            ...
                            <Button
                              className="px-3 py-2 flex items-center gap-2 bg-primary text-white hover:bg-primary/90 transition"
                              variant="solid"
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            errorMessage={
                              errors.declarationDate?.message as string
                            }
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(6,8,15,0.70), rgba(17,24,39,0.60))",
                  ...
                  >
                    {toast.type === "success" ? (
                      ...
                      >
                        ...
                        />
                        <path
                          d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94A2 2 0 0 0 23 18L14.5 3.86a2 2 0 0 0-3.21 0z"
                          stroke="#fff"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          strokeWidth="1.2"
