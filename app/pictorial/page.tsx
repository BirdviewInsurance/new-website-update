        ...
        <main className="relative w-screen min-h-screen overflow-hidden bg-white dark:bg-black text-gray-900 dark:text-gray-100 transition-colors duration-700">
            ...
            <section className="relative h-[85vh] w-full overflow-hidden">
                ...
                >
                    <p>
                        Trusted by{" "}
                        <span className="font-bold text-white">500,000+</span> families across Africa
                    </p>
                </motion.div>
            </section>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                            Every face tells a story of resilience and care. Our commitment goes beyond
                            policies — we build legacies, protect livelihoods, and empower futures with
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {galleryImages.slice(1, 5).map((src, idx) => (
                            ...
                            >
                                <img src={src} alt={`people-${idx}`} className="w-full h-48 sm:h-56 object-cover" />
                            </motion.div>
                        ))}
                    </div>
                </div>
