    ...
    <html suppressHydrationWarning lang="en">
      <head>
        ...
        <meta
          ...
          content="0qnc1ZBwmtuyekrO4231Q-Yd4Mee2DiWpCLyurtRWRc"
        />
        ...
        <meta
          content="insurance,
            ...
            Kenyans In New Zealand,
            Kenyans In Europe,
            Kenyans In Asia,
            Kenyans In Africa,
            Kenyans In The World,
            Birdview Microinsurance Kenya,
            Birdview Microinsurance Solutions Kenya,
            Birdview Microinsurance Solutions Kenya,
            Birdview Nduthi,
            Bidrview Tuktuk,
            Bidrview Probation Guard,
            Bidrview AQUABIMA,
            Bidrview Quungana,
            Bidrview Kenyans In Manchester,
            Bidrview Kenyans In South Wales,
            Bidrview Kenyans In Japan,
            Bidrview Kenyans In South Africa,
            Bidrview Kenyans In Canada,
            Bidrview Kenyans In Australia,
            Bidrview Kenyans In New Zealand,
            Bidrview Kenyans In Europe,
            Bidrview Kenyans In Asia,
            Bidrview Kenyans In Africa,
            Bidrview Kenyans In The World,
            Bidrview Birdview Microinsurance Kenya,
            Bidrview Birdview Microinsurance Solutions Kenya,
            Bidrview Birdview Microinsurance Solutions Kenya,
            Bidrview Birdview Nduthi,
            Bidrview Birdview Tuktuk,
            Bidrview Birdview Probation Guard,
            Bidrview Birdview AQUABIMA,
            Bidrview Birdview Quungana,
            Bidrview Birdview Kenyans In Manchester,
            Bidrview Birdview Kenyans In South Wales,
            Bidrview Birdview Kenyans In Japan,
            Bidrview Birdview Kenyans In South Africa,
            Bidrview Birdview Kenyans In Canada,
            Bidrview Birdview Kenyans In Australia,
            Bidrview Birdview Kenyans In New Zealand,
            Bidrview Birdview Kenyans In Europe,
            Bidrview Birdview Kenyans In Asia,
            Bidrview Birdview Kenyans In Africa,
            Bidrview Birdview Kenyans In The World,
          ...
          name="keywords"
        />
        <meta content="Birdview Microinsurance" name="author" />
      </head>
      <body
        className={clsx(
          ...
          <div className="flex flex-col min-h-screen relative z-10">
            ...
            <footer className="w-full flex flex-col items-center justify-center py-6 bg-primary text-white border-t-4 border-danger">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      ...
                      {
                        href: "/our-leadership#executives",
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      ...
                      },
                      {
                        ...
                        label: "BodaBoda Welfare Cover",
                      },
                      {
                        href: "/products/tuktuk_welfare",
                        label: "Tuktuk Welfare Cover",
                      },
                      {
              ...
              <div className="max-w-7xl w-full px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white">
                <p>
                  Location: Ground Floor, Fidelity Center, Waiyaki Way,
                  Westlands, Nairobi, Kenya
                </p>

                <div className="max-w-7xl w-full px-6 py-2 flex justify-center text-sm text-white text-center">
                  <p>
                    © {new Date().getFullYear()} Birdview Microinsurance. All
                    rights reserved. Regulated by the Insurance Regulatory
                    Authority.
                  </p>
                </div>
