...
export default function CookiePolicyPage() {
  const sections = [
    ...
    },
    {
      ...
      content: (
        <ul className="list-disc ml-6 space-y-2">
          <li>
            <b>Essential Cookies</b> – Necessary for core site operations like
            login and page navigation.
          </li>
          <li>
            <b>Performance Cookies</b> – Help us understand site traffic and
            usage for continual improvement.
          </li>
          <li>
            <b>Functional Cookies</b> – Remember preferences like language,
            region, or theme settings.
          </li>
          <li>
            <b>Analytics Cookies</b> – Track anonymous site usage to optimize
            our digital services.
          </li>
          <li>
            <b>Marketing Cookies</b> – Deliver tailored content and measure
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>
            You have full control over your cookie preferences. Most browsers
            allow you to manage or delete cookies at any time. You can also opt
            out of non-essential cookies via our{" "}
            <b>Cookie Preferences Center</b>.
          </p>
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>
              Reject analytics and marketing cookies directly on our website.
            </li>
          </ul>
        </div>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          If you have any questions about our Cookie Policy or wish to exercise
