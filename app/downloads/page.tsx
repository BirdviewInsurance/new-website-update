...
export default function DownloadsPage() {
  ...
  const categories = useMemo(() => {
    const uniqueCategories = Array.from(
      new Set(SAMPLE_DOWNLOADS.map((d) => d.category)),
    );
              ...
              >
                ...
                <div className="mt-5 flex items-center justify-between gap-2">
                  ...
                  <div className="flex gap-2">
                    <button className="px-3 py-1.5 rounded-md text-xs font-medium border border-[var(--brand-danger)] text-[var(--brand-danger)] hover:bg-[var(--brand-danger)] hover:text-white transition-all">
                      Preview
                    </button>
                    <button className="px-3 py-1.5 rounded-md text-xs font-medium bg-[var(--brand-primary)] text-white hover:opacity-90 transition-all">
                      Request
                    </button>
                  </div>
                </div>
