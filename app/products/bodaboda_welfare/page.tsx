    ...
    <div className="relative bg-gradient-to-b from-gray-50 to-gray-100 py-16">
      ...
      >
        ...
        <p className="mt-6 text-xl text-gray-700 leading-relaxed">
          ...
          , offering hospital support, accident protection, and family peace of
          mind under one trusted brand.
        </p>
      </motion.div>
        ...
        >
          <CardBody className="px-10 py-12 space-y-6">
            ...
            <p className="text-lg text-blue-100 max-w-2xl mx-auto leading-relaxed">
              Every journey deserves peace of mind. Join thousands of BodaBoda
              riders who trust Birdview to keep their families and livelihoods
              secure.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <Button
                ...
                variant="bordered"
                onClick={() =>
                  window.open("https://birdviewmicroinsurance.com/contact")
                }
              >
                Talk to an Agent
              </Button>
