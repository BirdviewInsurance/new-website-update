export const allLeaders = [
  ...
  },
  {
    ...
    category: "Executive Leadership",
    bio: "Eve is leading Partnerships and Strategic growth a role that is poised to place Birdview as the leading Micro Insurance provider in Kenya, the region and diaspora. Eve Wanjira Ndegwa is a Micro Insurance Enthusiast with a career spanning 25 years in the Insurance Industry. She is deeply passionate about Insurance as a tool for social impact, poverty alleviation and economic empowerment. Her greatest desire is to contribute to meaningful financial solutions for low-income households in a sustainable and mutually beneficial manner. In the last 13 years, Eve was involved in setting up the Micro Insurance business from scratch in leading Insurance companies in Kenya.During this time, she acquired vast experience in Micro Insurance strategy development, and implementation.She spent most of her career in Micro Insurance distribution, sales and marketing.Eve is very passionate about Training and Consumer Education and is also skilled in writing of business plans, concept notes and proposals.Her last engagement before joining Birdview Micro Insurance was leading Health Premium Financing role at HealthPartners USIAD a role that sharpened her skills in project management and donor engagement.",
    ...
    cta: {
      ...
      button: "Explore Eve’s Growth Initiatives",
      link: "/insights/eve-wanjira",
    },
  },
  {
    name: "Ann Kinyanjui",
