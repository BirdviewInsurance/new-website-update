      ...
      >
        <Card className="shadow-xl backdrop-blur-lg bg-white/70 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700">
          <CardBody className="text-center py-16">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-emerald-500 to-teal-400 bg-clip-text text-transparent mb-4">
              How It Works
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              The step-by-step guide for this coverage is being finalized.
              Stay tuned for detailed process insights soon!
            </p>
          </CardBody>
        </Card>
      </motion.div>
