      ...
      >
        <Card className="shadow-xl backdrop-blur-lg bg-white/70 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700">
          <CardBody className="text-center py-16">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-yellow-400 bg-clip-text text-transparent mb-4">
              Frequently Asked Questions
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              The FAQ section for this plan is being updated.
